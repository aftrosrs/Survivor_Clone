...
var IceSpear_Level = 0 #Globals.level

#Tornado
var Tornado_Ammo = 0
var Tornado_BaseAmmo = 0#set to zero as well as level for some reason
var Tornado_AttackSpeed = 3
var Tornado_Level = 0#Globals.level

#Javelin
var Javelin_Ammo = 3
var javelin_level = 1 #Globals.level
...
func spawn_javelin():
	...
	var calc_spawns = Javelin_Ammo - get_javelin_total# Javelins we want minus^ e.g: 3 - 0 = 3
	while calc_spawns > 0:
		var javelin_spawn = Javelin.instantiate()
		javelin_spawn.global_position = global_position#Spawns a javelin on the base node
