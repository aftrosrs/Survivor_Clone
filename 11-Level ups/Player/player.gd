...
func calculate_experience(gem_exp):#this one
...
func upgrade_character(_selected_upgrade):
...
func level_up():
	...
	while options < optionsMax:
		...
		UpgradeOptions.add_child(option_choice)#adds 3 children to level panel
		options += 1
